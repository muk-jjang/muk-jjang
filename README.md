...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| [**Casting Process Control Optimization Solution based Digital-Twin**](https://github.com/muk-jjang/2024_KAMP_casting_optimization_competition)|Through domain and data analysis, we selected important control variables in the casting process. XGB, LightGBM, EXT, FFTransformer, etc. were used to build the Digital- Twin model. Based on the learned Digital-Twin Bayesian optimization was used to derive the optimal control value for the state.|2024.11 - 2024.11|
